              ...
              <div className="grid lg:grid-cols-2 z-[2] gap-10">
                <div className="flex flex-col justify-center">
                  <div className="lg:pt-[10%]">
                    <h1 className="heading_one_black">{program?.title}</h1>
                        ...
                        {program?.agandaList?.length ? (
                          <>
                            {program.agandaList.map(
                              (aganda: AgendaItem, i: number) => {
                                return (
                                  <li className="flex" key={aganda._id}>
                                    <div className="journey_points">
                                      <svg
                                        width="40"
                                        height="40"
                ...
                <div className="hidden lg:block relative">
                  ...
                  <div className="hidden lg:block sticky left-0 top-[108px] w-[350px] mx-auto p-8 rounded-[20px] shadow-lg">
                    <p className="news_letter_form_head">{program?.title}</p>
                    <p>One time cost {program?.price}</p>
                    <ul className="flex flex-wrap items-center mt-8">
