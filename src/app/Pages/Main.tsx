  ...
  return (
    <>
      ...
      <section className="upcoming_program">
        <div className="container mx-auto ">
          <div className="lg:grid grid-cols-2 pb-8 lg:pb-20 lg:px-20">
            <h2 className="heading_style_two mb-8 lg:mb-0 text-[#29214B] lg:max-w-[398px] text-start md:text-center lg:text-left">
      ...
      <section className="testimonial_section">
        <h2 className="heading_style_two text-center text-[#29214B]">
          What people say
        </h2>
        <TestimonialCarousel />
      </section>
