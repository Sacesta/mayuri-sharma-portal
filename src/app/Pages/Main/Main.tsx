    ...
    <>
            ...
            <li className="program_list_li">
              ...
              <div className="program_details">
                ...
                <p className="program_description">
                  ...
                  here, with a bit more here and here and there everywhere. oh
      ...
      <section className="news_letter_section">
        <div className="container mx-auto">
          ...
          <h2 className="heading_style_two text-center max-w-[480px] mx-auto mb-[60px] lg:mb-24 text-[#29214B]">
            Let’s start your journey in my free masterclass{" "}
          </h2>
