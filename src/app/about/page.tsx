...
import social_img_2 from '../../Assets/Images/pageImages/BG.png';
import social_img_3 from '../../Assets/Images/pageImages/Social meida itemsocial3.png';
import social_img_4 from '../../Assets/Images/pageImages/BGsocial4.png';
import social_img_5 from '../../Assets/Images/pageImages/Social meida itemsocial5.png';
import social_img_6 from '../../Assets/Images/pageImages/Social meida itemsocial6.png';
        ...
        <div className="relative about_missiongoes">
          <div className="mission container mx-auto">
            <div className="max-w-[750px] text-center">
              ...
              <p className="news_letter_head pb-2 mt-14">My vision</p>
              <p className="text-white text-lg font-normal leading-7">
                {cardBody.line2}
              </p>
            </div>
        ...
        <div className="container mx-auto ">
          ...
          <div className="grid grid-rows-3 md:grid-cols-3 md:grid-flow-col gap-10">
            <div className="social_image">
              <Image src={social_img_1} alt="program..." className=" " />
            ...
            <div className="row-span-2 social_image">
              <Image src={social_img_4} alt="program..." className=" " />
              <div className="insta_podcast">
                <svg
                  width="30"
                  height="30"
            ...
            <div className="row-span-2 social_image">
              <Image src={social_img_2} alt="program..." className=" " />
              <div className="insta_podcast">
                <svg
                  width="30"
                  height="30"
            ...
            <div className="social_image">
              <Image src={social_img_3} alt="program..." className=" " />
              <div className="insta_podcast">
                <svg
                  width="30"
                  height="30"
            ...
            <div className="row-span-2 social_image">
              <Image src={social_img_6} alt="program..." className=" " />
              <div className="insta_podcast">
                <svg
                  width="30"
                  height="30"
