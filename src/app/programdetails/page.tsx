        ...
        <div className="lg:bg-right container mx-auto">
          <div className="grid lg:grid-cols-2 z-[2] gap-10">
            <div className="flex flex-col justify-center">
              <div className="lg:pt-[10%]">
                ...
                <p className="text-lg text-[#2B2B27] font-normal leading-7 mt-4 lg:mt-8">
                  A bit of text about the programs can go here. Lorem ipsum
                ...
                <div className="mb-12 lg:mb-[100px]">
                  ...
                  <div className="p-8 border border-[#E1E1E1] rounded-[20px] bg-white relative overflow-hidden mb-4">
                    ...
                    <p className="lg:w-2/3">
                      ...
                      includes offering a variety of resources and tools that
                      can be accessed online, as well as providing support
                      through mobile apps, virtual coaching sessions, and other
                      digital platforms
                    </p>
                  ...
                  <div className="p-8 border border-[#E1E1E1] rounded-[20px] bg-white relative overflow-hidden mb-4">
                    ...
                    <p className="lg:w-2/3">
                      Personalized approach to each individual, taking into
                      account their unique needs, goals, and preferences. This
                      includes personalized assessments, recommendations, and
                ...
                <div>
                  ...
                  <div className="p-8 border border-[#E1E1E1] rounded-[20px] bg-white relative overflow-hidden mb-4">
                    ...
                    <p className="lg:w-2/3">
                      ...
                      supporters has been a game-changer. The encouragement and
                      accountability from members have helped me develop
                      healthier habits and improve my mental well-being. The
                      shared insights and resources have been transformative,
                      and the sense of belonging is amazing!&quot; - John
                    </p>
                  ...
                  <div className="p-8 border border-[#E1E1E1] rounded-[20px] bg-white relative overflow-hidden mb-4">
                    ...
                    <p className="lg:w-2/3">
                      ...
                      strategies and support from like-minded members have
                      helped me prioritize my mental health and build positive
                      habits. The progress I&apos;ve made and the connections
                      I&apos;ve formed are invaluable. Highly recommend!&quot; -
                      Tammy
                    </p>
                    <div className="absolute right-0 top-0 h-16 w-16 lg:h-[120px] lg:w-[120px] rounded-s-full rounded-br-full flex items-center justify-center overflow-hidden">
                      <Image
            ...
            <div className="hidden lg:block relative">
              ...
              <div className="hidden lg:block sticky left-0 top-[108px] w-[350px] mx-auto p-8 rounded-[20px] shadow-lg">
                <p className="news_letter_form_head">Wellness Program</p>
