      ...
      <section className="upcoming_program programs">
        <div className="container mx-auto ">
          <div className="lg:grid grid-cols-2 pb-8 lg:pb-20 lg:px-20">
            <p className=" max-w-xl ">A bit of text about the programs can go here. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            </p>
          </div>
            ...
            <div className="news_letter">
              <div className="lg:w-1/2 flex items-center z-[2]">
                <div>
                  ...
                  <h2 className="news_letter_h2">Get updated when new programs start</h2>
