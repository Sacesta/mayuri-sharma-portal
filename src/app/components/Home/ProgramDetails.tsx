        ...
        <div className="lg:bg-right container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 z-[2] gap-10">
            <div className="flex flex-col justify-center">
              ...
              <p className="text-lg text-[#2B2B27] font-normal leading-7 mt-4 lg:mt-8">A bit of text about the programs can go here. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div className="rounded-[20px] overflow-hidden h-[358px] lg:h-full w-full">
              <Image src={programDetailsBanner} alt="..." className="h-full w-full object-cover"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white pt-[100px] pb-[119px]">
        <div className="container mx-auto">
          <div className="faqs max-w-[728px] mx-auto">
            ...
            <div className="accordian">
              ...
              <div className="accordian_item">
                ...
                <div id="collapseTwo" className="accordion_collapse hidden show">
                  <div className="accordion_body">
                  Answer goes here Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.
                  </div>
                </div>
              ...
              <div className="accordian_item">
                ...
                <div id="collapseThree" className="accordion_collapse hidden show">
                  <div className="accordion_body">
                  Answer goes here Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.
                  </div>
                </div>
          ...
          <div className="mt-[132px] lg:mt-[59px]">
            <h2 className="heading_style_two text-center text-[#2B2B27] mb-4">Still have a question?</h2>
